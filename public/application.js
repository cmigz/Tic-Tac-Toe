...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).done(ui.onSignUpSuccess).fail(ui.onSignUpFail);
};

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signIn(data).done(ui.onSignInSuccess).fail(ui.onSignInFail);
};
...
var onGetGames = function onGetGames(event) {
  event.preventDefault();
  api.index().then(ui.getSuccess).catch(ui.fail);
  console.log(api.index());
};

var onCreateGame = function onCreateGame(event) {
  event.preventDefault();
  api.createGame().then(ui.onCreateGameSuccess).catch(ui.fail);
};

var onUpdateGame = function onUpdateGame(index, value, over) {
  api.updateGame(index, value, over).then(ui.onUpdateSuccess).catch(ui.onUpdateFail);
};
...
var winner = ''; // Options in checkForWin = playerX, playerO, Draw
var playerTurn = 'x';
var xWinCount = 0;
var oWinCount = 0;
var value = void 0;
...
var checkForWin = function checkForWin() {
  if ($('#A1').hasClass('symX') && $('#A2').hasClass('symX') && $('#A3').hasClass('symX') || $('#B1').hasClass('symX') && $('#B2').hasClass('symX') && $('#B3').hasClass('symX') || $('#C1').hasClass('symX') && $('#C2').hasClass('symX') && $('#C3').hasClass('symX') || $('#A1').hasClass('symX') && $('#B1').hasClass('symX') && $('#C1').hasClass('symX') || $('#A2').hasClass('symX') && $('#B2').hasClass('symX') && $('#C2').hasClass('symX') || $('#A3').hasClass('symX') && $('#B3').hasClass('symX') && $('#C3').hasClass('symX') || $('#A1').hasClass('symX') && $('#B2').hasClass('symX') && $('#C3').hasClass('symX') || $('#A3').hasClass('symX') && $('#B2').hasClass('symX') && $('#C1').hasClass('symX')) {
    winner = 'playerX';
  ...
  } else if ($('#A1').hasClass('symO') && $('#A2').hasClass('symO') && $('#A3').hasClass('symO') || $('#B1').hasClass('symO') && $('#B2').hasClass('symO') && $('#B3').hasClass('symO') || $('#C1').hasClass('symO') && $('#C2').hasClass('symO') && $('#C3').hasClass('symO') || $('#A1').hasClass('symO') && $('#B1').hasClass('symO') && $('#C1').hasClass('symO') || $('#A2').hasClass('symO') && $('#B2').hasClass('symO') && $('#C2').hasClass('symO') || $('#A3').hasClass('symO') && $('#B3').hasClass('symO') && $('#C3').hasClass('symO') || $('#A1').hasClass('symO') && $('#B2').hasClass('symO') && $('#C3').hasClass('symO') || $('#A3').hasClass('symO') && $('#B2').hasClass('symO') && $('#C1').hasClass('symO')) {
    winner = 'playerO';
    console.log(winner + ' has won the game');
    oWinCount++;
...
var onChangePasswordFail = function onChangePasswordFail(error) {
